...
import org.example.core.exception.OutOfRangeException;
import org.example.core.parser.ParserToken;
import org.example.core.utils.NumericUtils;
...
public final class NumberNode extends Node {
    ...
    private int exponent(int endIndex) {
        ...
        // The exponent is everything after 'e', it will overflow and Java will wrap around to 64770077. This is the
